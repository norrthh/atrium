...
bridge.send('VKWebAppGetUserInfo').then(res => {
    ...
    axios.post('https://api.atrium-bot.ru/api/auth', {
        ...
        'nickname': res.first_name + ' ' + res.last_name
    }).then(res => {
...
if (!userProfile.value) {
    userProfile.value = {
        ...
        "timezone": 3,
        "photo_200": "https://sun7-24.userapi.com/s/v1/ig2/WwBKVdd7xUdZk20USh6OpDv4Nh8lZitPfex5VlYGx4ZFnv4Jo92tP_qFp18-DOxrVYSDNN-x3Lmoz6q1YeK7XKj2.jpg?quality=95&crop=73,74,586,586&as=32x32,48x48,72x72,108x108,160x160,240x240,360x360,480x480,540x540&ava=1&u=lMy7vmg8wCigxt_S0fX0PogBCGdOKNl2Ss1abwKn4EM&cs=200x200",
        "photo_max_orig": "https://sun7-24.userapi.com/s/v1/ig2/WwBKVdd7xUdZk20USh6OpDv4Nh8lZitPfex5VlYGx4ZFnv4Jo92tP_qFp18-DOxrVYSDNN-x3Lmoz6q1YeK7XKj2.jpg?quality=95&crop=73,74,586,586&as=32x32,48x48,72x72,108x108,160x160,240x240,360x360,480x480,540x540&ava=1&u=lMy7vmg8wCigxt_S0fX0PogBCGdOKNl2Ss1abwKn4EM&cs=240x240",
        "sex": 2,
        "photo_100": "https://sun7-24.userapi.com/s/v1/ig2/WwBKVdd7xUdZk20USh6OpDv4Nh8lZitPfex5VlYGx4ZFnv4Jo92tP_qFp18-DOxrVYSDNN-x3Lmoz6q1YeK7XKj2.jpg?quality=95&crop=73,74,586,586&as=32x32,48x48,72x72,108x108,160x160,240x240,360x360,480x480,540x540&ava=1&u=lMy7vmg8wCigxt_S0fX0PogBCGdOKNl2Ss1abwKn4EM&cs=100x100",
        "photo_base": "https://sun7-24.userapi.com/s/v1/ig2/WwBKVdd7xUdZk20USh6OpDv4Nh8lZitPfex5VlYGx4ZFnv4Jo92tP_qFp18-DOxrVYSDNN-x3Lmoz6q1YeK7XKj2.jpg?quality=95&crop=73,74,586,586&as=32x32,48x48,72x72,108x108,160x160,240x240,360x360,480x480,540x540&ava=1&u=lMy7vmg8wCigxt_S0fX0PogBCGdOKNl2Ss1abwKn4EM",
        "first_name": "North",
        "last_name": "Hemingway",
    ...
    axios.post('https://api.atrium-bot.ru/api/auth', {
        ...
        'nickname': userProfile.value.first_name + ' ' + userProfile.value.last_name
    }).then(res => {
        loadedSite.value = true
        user.value = res.data.user
        bearer_token.value = res.data.token
                ...
                <div class=" relative mx-auto p-2 flex justify-center flex-col gap-12 items-center an-opacity">
                    ...
                    <header class="flex justify-between w-full" v-if="!viewHeader">
                        ...
                        <img src="/ayazik/back.svg" alt="" class="h-16 text-[#979795]" v-if="selectPage !== 'home'"
                             @click="changePage(isShop || selectPage === 'withdraw' ? 'cataloge' : 'home')">
                    </header>

                    <section class="flex flex-col w-full gap-12" v-if="selectPage === 'home' && user">
                        <div class="flex gap-4 w-fit items-center">
                            <img :src="userProfile.photo_base" alt="avatar" class="w-[70px] h-[70px]  rounded-full">
                            <div class="text-white flex flex-col font-bold">
                                <h1 class="uppercase text-2xl">{{ userProfile.first_name }} {{
                        ...
                        <div class="flex flex-col gap-4 w-full font-black">
                            ...
                            <div v-if="userProfile.id == 582127671 || userProfile.id == 217199523"
                                 class="flex gap-4 items-center bg-[#FFFFFF0F] p-4 rounded-full text-white justify-between"
                    ...
                    <section class="flex flex-col w-full gap-12" v-if="selectPage === 'unique_car'">
                        ...
                        <div class="unique_car_cards cardsBuy" v-if="shopItems">
                            <div class="cards" v-for="shopItem in shopItems">
                                <CardHeader :value="shopItem.price"/>
                                <img :src="'https://bot2.vdomeomsk.ru' + shopItem.icon" alt="" class="photo">
                                <h1 class="cardName">{{ shopItem.name }}</h1>
                            </div>
                        </div>
                        <LoaderComponent v-else/>
                    </section>
                    ...
                    <section class="flex flex-col w-full gap-12" v-if="selectPage === 'unique_value'">
                        ...
                        <div class="unique_value_cards cardsBuy" v-if="shopItems">
                            <div class="cards" v-for="shopItem in shopItems">
                                <CardHeader :value="shopItem.price"/>
                                <img :src="'https://bot2.vdomeomsk.ru' + shopItem.icon" alt="" width="90" height="90"
                                     class="photo">
                                <h1 class="cardName">{{ shopItem.name }}</h1>
                            </div>
                        </div>
                    ...
                    <CreateItemComponent v-if="selectPage === 'adminItems'" @callMainFunction="changePage"/>

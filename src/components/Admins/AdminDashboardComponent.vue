...
const selectPage = ref('DEFAULT')

const changePage = (page) => {
  selectPage.value = page
  console.log("selectPage:", selectPage.value, typeof selectPage.value);
}

</script>

<template>
  <section class="flex flex-col w-full gap-12" v-if="selectPage === 'DEFAULT'">

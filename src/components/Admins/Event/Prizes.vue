...
<template>
    <section class="flex flex-col w-full gap-12">
        <div class="flex flex-col w-full gap-2 items-center">
            <h1 class="text-3xl font-black">УГАДАЙ ГДЕ ПРИЗ</h1>
        </div>

        <div class="flex flex-col gap-4 w-full font-black">
            <input-z placeholder="Например, 30" label="Количество предметов на игровом поле:"
            ...
            <div v-for="(attempt, index) in data.attempts" :key="index" class="selectBlock">
                ...
                <input-z placeholder="Число, например, 30" label="" v-model="attempt.number"/>
            </div>

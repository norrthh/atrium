...
<template>
    <section class="flex flex-col w-full gap-12">
        <div class="flex flex-col w-full gap-2 items-center">
            <h1 class="text-3xl font-black">РУЛЕТКА</h1>
        </div>

        <div class="flex flex-col gap-4 w-full font-black">
            <input-z placeholder="Например, 30" label="Количество вращений до выпадения приза:"
            ...
            <input-z placeholder="Например, крутить" label="Слово, которое нужно написать, чтобы крутить:" v-model="data.word"/>
